...
const HTML_DUMP = resolve(root, "tmp/lazyowen-agency/article.html");
const IMAGE_DIR = resolve(root, "tmp/lazyowen-agency");

export const SOURCE_URL = "https://lazyowen.com/guides/agency-agents-7seats";
export const PAGE_TITLE =
  "무료 AI 에이전트 명단에서 먼저 깔아야 할 일곱 자리";
...
export const REQUIRED_HREFS = [
  ...
  "https://github.com/msitarzewski/agency-agents/blob/main/security/security-ai-generated-code-auditor.md",
...
const IMAGE_BYTES = {
  "g1-flow.webp": 64058,
  "g2-seats.webp": 81436,
  "g4-result.webp": 80490,
  "g3-brief-ox.webp": 79638,
};
