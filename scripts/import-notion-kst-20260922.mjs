...
/** 이미 이관한 페이지 hex. 캘린더·컬렉션 행과 함께 TARGETS에 넣지 않는다. */
const SKIPPED_HEXES = [
...
export const TARGETS = [
  {
    ...
    hex: "285b256827ac829cb58381e6c9409da2",
    pageId: "285b2568-27ac-829c-b583-81e6c9409da2",
    sourceUrl: "https://app.notion.com/p/285b256827ac829cb58381e6c9409da2",
    images: 0,
    attachments: 0,
    root: 66,
    tables: 12,
    codes: 3,
    phrases: ["폴더 구조", "research.md", "30분 설치", "CLAUDE.md"],
    requiredHrefs: [
