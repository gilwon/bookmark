...
export const TARGETS = [
  {
    key: "claude",
    title: "클로드 천재 치트키 100",
    hex: "74bb256827ac825fa8d58169b753ea7c",
    pageId: "74bb2568-27ac-825f-a8d5-8169b753ea7c",
    sourceUrl: "https://app.notion.com/p/74bb256827ac825fa8d58169b753ea7c",
    body: "tmp/notion-kst-20260909/claude-cheat.md",
    cover: "tmp/notion-kst-20260909/claude-cheat-cover.png",
    images: 1,
    attachments: 0,
    callouts: 4,
    codesMin: 70,
    phrases: [
      "볼드 금지 룰 지우기",
      "**100.",
      "open.kakao.com/o/gvD2nbhg",
      "@nookitokki",
    ],
  },
  {
    key: "chatgpt",
    title: "ChatGPT 천재 만드는 치트키 100 — 복붙 전체본",
    hex: "82fb256827ac83398a3a81950bc7ff10",
    pageId: "82fb2568-27ac-8339-8a3a-81950bc7ff10",
    sourceUrl: "https://app.notion.com/p/82fb256827ac83398a3a81950bc7ff10",
    body: "tmp/notion-kst-20260909/chatgpt-cheat.md",
    cover: "tmp/notion-kst-20260909/chatgpt-cheat-cover.png",
    images: 1,
    attachments: 0,
    callouts: 3,
    codesMin: 70,
