...
const SPACE_ID = "144c0a47-286c-4df3-a01a-d12ddd277c4b";
...
const EXPECTED_ROOT_CHILDREN = 38;
const EXPECTED_CODES = 3;
const EXPECTED_CALLOUTS = 2;
const EXPECTED_TABLES = 0;

export const SOURCE_URL =
  "https://fieldby.notion.site/GPT-3-3d2d730b395381b2bc99c7b7bb38660c";
export const PAGE_TITLE =
  "챗GPT로 인터넷에 흩어진 내 정보 지우기  프롬프트 3개 정리본";
export const NOTION_PAGE_ID = "3d2d730b-3953-81b2-bc99-c7b7bb38660c";
export const PAGE_HEX = "3d2d730b395381b2bc99c7b7bb38660c";
