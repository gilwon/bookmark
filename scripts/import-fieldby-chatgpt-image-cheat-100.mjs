...
const EXPECTED_ROOT_CHILDREN = 22;
const EXPECTED_TABLES = 9;
const EXPECTED_TABLE_ROWS = 109;
const EXPECTED_COMMANDS = 100;
const EXPECTED_CALLOUTS = 2;
...
export const PAGE_TITLE = "ChatGPT 이미지 치트키 100개 총정리";
export const NOTION_PAGE_ID = "3ced730b-3953-81dd-a7b2-c5a8d3516839";
export const PAGE_HEX = "3ced730b395381dda7b2c5a8d3516839";
...
export function commandCount(blocks) {
  ...
  for (const block of blocks.values()) {
    ...
    if (cells.includes("명령어") && cells.includes("효과")) continue;
...
function assertIntegrity({ page, blocks, pageTitle, markdown, stats, content }) {
  ...
  if (countType(blocks, "callout") !== EXPECTED_CALLOUTS) {
    throw new Error(`콜아웃 수가 다릅니다. ${countType(blocks, "callout")}`);
  }
